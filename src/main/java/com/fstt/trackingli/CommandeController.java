...
public class CommandeController implements Initializable {
    ...
    void switchToTracking2(ActionEvent event) throws IOException {
        ...
        Parent trackingParent = FXMLLoader.load(getClass().getResource("/Fxml/TrackingLi1.fxml"));
        Scene trackingScene = new Scene(trackingParent);
    ...
    void switchToTracking3(ActionEvent event) {
        ...
        try {
            trackingParent = FXMLLoader.load(getClass().getResource("/Fxml/Login.fxml"));
        } catch (IOException e) {
    ...
    void switchToTracking4(ActionEvent event) {
        Parent trackingParent = null;
        try {
            trackingParent = FXMLLoader.load(getClass().getResource("/Fxml/mixed.fxml"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        Scene trackingScene = new Scene(trackingParent);
