...
public class CommandeDAO  extends BaseDAO {
    ...
    public void  savec(Commande object){
        String request = "insert into commandes (Adresse ,date_debut, date_fin, id) values (?,?, ?,?)";
    ...
    public  void updatec(Commande object,int idcommande){
        String query ="update commandes set Adresse = ?, date_debut = ?, date_fin= ? where idcommande = ?";
        try {
